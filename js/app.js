    ...
    createItemElement(item, index) {
        ...
        li.innerHTML = `
            <div class="checkbox-wrapper">
                <input type="checkbox" class="check item-checkbox" id="check-${item.id}" ${item.completed ? 'checked' : ''}>
                <label for="check-${item.id}" class="label">
                    <svg width="28" height="28" viewBox="0 0 95 95">
                        <rect x="30" y="20" width="50" height="50" stroke="currentColor" fill="none" stroke-width="2"></rect>
                        <g transform="translate(0,-952.36222)">
                            <path d="m 56,963 c -102,122 6,9 7,9 17,-5 -66,69 -38,52 122,-77 -7,14 18,4 29,-11 45,-43 23,-4" stroke="currentColor" stroke-width="3" fill="none" class="path1"></path>
                        </g>
                    </svg>
                </label>
            </div>
